// EXAMPLE CODE FROM https://docs.opencv.org/4.1.1/da/d5c/tutorial_canny_detector.html
// Then modified to help me save the final image
...
int main( int argc, char** argv )
{
  ...
  CannyThreshold(0, 0);
  waitKey(0);
  String output_path = imgName.substr(0, imgName.find_last_of('.')) + "_canny.jpg";
